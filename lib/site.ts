...
export const site = {
  name: "Vibemart",
  positioning: "Something for every vibe, all in one place.",
  demoNotice: "Vibemart is a fictional demonstration storefront.",
...
export const storePolicies = [
  ...
  {
    title: "Opening hours",
    content: "The demonstration storefront is available online at any time and has no physical locations.",
  },
] as const;
